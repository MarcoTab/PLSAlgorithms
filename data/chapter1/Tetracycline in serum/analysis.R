rm(list=ls())
library(pls)
setwd("~/Dropbox/pls-book/PLSbook/Data-analysis/mvc1_data_Frabricio/mvc1_data/Tetracycline in serum")
#Tetracycline in serum
ycal <- read.table("ycal.txt", quote="\"", comment.char="")

ytest <- read.table("ytest.txt", quote="\"", comment.char="")
...
points(ytest,pred_lasso,col='green')
