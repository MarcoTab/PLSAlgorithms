...
# Read in corn data
X_train = np.genfromtxt('data/chapter1/Parameters in corn/Xcal.txt', delimiter="  ")
X_train = X_train.T
Y_train = np.genfromtxt('data/chapter1/Parameters in corn/y1cal.txt', delimiter="  ")

X_test = np.genfromtxt('data/chapter1/Parameters in corn/Xtest.txt', delimiter="  ")
X_test = X_test.T
Y_test = np.genfromtxt('data/chapter1/Parameters in corn/y1test.txt', delimiter="  ")
...
# Read in meat data
X_train = np.genfromtxt('data/chapter1/Parameters in meat/Xcal.txt', delimiter="  ")
X_train = X_train.T
Y_train = np.genfromtxt('data/chapter1/Parameters in meat/y3cal.txt', delimiter="  ")

X_test = np.genfromtxt('data/chapter1/Parameters in meat/Xtest.txt', delimiter="  ")
X_test = X_test.T
Y_test = np.genfromtxt('data/chapter1/Parameters in meat/y3test.txt', delimiter="  ")
...
X_train = np.genfromtxt('data/chapter1/Tetracycline in serum/Xcal.txt', delimiter="  ")
X_train = X_train.T
Y_train = np.genfromtxt('data/chapter1/Tetracycline in serum/ycal.txt', delimiter="  ")

X_test = np.genfromtxt('data/chapter1/Tetracycline in serum/Xtest.txt', delimiter="  ")
X_test = X_test.T
Y_test = np.genfromtxt('data/chapter1/Tetracycline in serum/ytest.txt', delimiter="  ")
